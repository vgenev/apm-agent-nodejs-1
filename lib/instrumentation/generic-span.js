...
function GenericSpan (agent, type, opts, outerContext = null) {
  this._timer = new Timer(opts.timer, opts.startTime)
  this._context = outerContext || TraceParent.startOrResume(opts.childOf, agent._conf) // _context is used by the OT bridge, and should unfortunately therefore be considered public
  this._agent = agent
  this._labels = null
